    ...
    <div className="dark min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 pt-12 pb-16 sm:py-20 space-y-8 sm:space-y-10">
        ...
        <div className="font-sans text-[15px] sm:text-base md:text-lg text-muted-foreground leading-relaxed space-y-4">
          ...
          <p>
            We help purpose-driven teams <span className="text-foreground font-medium">unify fragmented knowledge</span> and protect your team's golden thread, building <span className="text-foreground font-medium">truly empowering systems</span> that bridge the context wall, so your people are freed up to do their most strategic and creative work, not replaced by a machine.
          </p>
          <p>
