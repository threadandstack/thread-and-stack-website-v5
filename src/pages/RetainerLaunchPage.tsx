      ...
      <div className="bg-background w-full max-w-[780px] rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.10)] overflow-hidden print:shadow-none print:rounded-none print:max-w-full">
        ...
        <div className="px-14 pt-[52px] pb-14 max-sm:px-7 max-sm:pt-9 max-sm:pb-9">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-primary text-primary-foreground">
                  <th className="font-sans text-[11px] font-semibold tracking-wider uppercase px-5 py-3.5 text-left">Engagement type</th>
              ...
              <tbody>
                <tr className="bg-muted">
                  ...
                  <td className="px-5 py-4 text-[13.5px] text-foreground align-top">~£3,500–£4,100</td>
                </tr>
                <tr className="bg-card">
                  <td className="px-5 py-4 font-serif-pro italic text-[15px] font-semibold text-primary align-top">Scale-ups & established orgs</td>
                  <td className="px-5 py-4 text-[13.5px] text-foreground align-top"><span className="font-sans text-[15px] font-bold text-primary">£900–£1,000+</span></td>
                  <td className="px-5 py-4 text-[13.5px] text-foreground align-top">1–2 days / week</td>
                  <td className="px-5 py-4 text-[13.5px] text-foreground align-top">~£4,500–£8,900+</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <p className="text-[13px] text-muted-foreground leading-relaxed mt-3.5">
            Start with a short initial term, then review together. The cadence adjusts around what the business actually needs — lighter when things are steady, more intensive around key moments. Additional days or short launch intensives can be added at an agreed rate.
          </p>
        </div>
...
export default RetainerLaunchPage;
