  ...
  return (
    <div className="min-h-screen">
      ...
      {tiers.map((tier, index) => {
        ...
        return (
          <section key={index} className={`py-20 px-6 ${sectionBg}`}>
            <div className="max-w-5xl mx-auto">
              <div className="grid md:grid-cols-2 gap-12 items-start">
                ...
                <div>
                    ...
                    <div>
                      ...
                      <p
                        className={`text-sm font-sans ${
                          isAccent ? "opacity-80" : "text-accent"
                        }`}
                      >
                        {tier.label}
                      </p>
                  ...
                  <p
                    className={`font-sans font-medium mb-3 ${
                      isAccent ? "opacity-90" : "text-foreground"
                    }`}
                  >
                    {tier.tagline}
                  </p>
                ...
                <div>
                  <h3
                    className={`font-semibold font-sans mb-4 ${
                      isAccent ? "" : ""
                    }`}
                  >
                    What's Included
                  ...
                  <ul className="space-y-3">
                    {tier.includes.map((item, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        ...
                        <span
                          className={`font-sans ${
                            isAccent ? "opacity-90" : "text-muted-foreground"
                          }`}
                        >
                          {item}
                        </span>
