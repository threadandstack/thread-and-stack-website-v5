            ...
            <div className="flex gap-3.5 items-start text-accent">
              ...
              <div className="flex-1">
                ...
                <div className="font-sans text-[13.5px] text-foreground leading-[1.65]">
                  <strong className="text-primary">50% on project kick-off, 50% on delivery.</strong> Invoices for both payments are issued upfront so you can schedule them in advance and route them through your internal approvals without any last-minute pressure. A 15% late charge applies to any payment not received within 30 days of invoicing.
                </div>
              </div>
            </div>
          </div>
