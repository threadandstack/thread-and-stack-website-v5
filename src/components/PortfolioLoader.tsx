    ...
    <div className="flex flex-col items-center justify-center px-6 py-20 gap-5">
      <div className="relative w-20 h-20">
        ...
        >
          ...
          {/* Liquid fill — two sine waves rising */}
          <g clipPath={`url(#circle-${uid})`}>
            {/* Back wave */}
            <path
              className="animate-portfolio-wave-back"
              fill="hsl(var(--accent))"
              opacity="0.35"
              d=""
            >
              <animate
                ...
                values="
                  M0,85 C15,80 30,90 50,85 C70,80 85,90 100,85 L100,100 L0,100 Z;
                  M0,80 C20,85 35,75 50,80 C65,85 80,75 100,80 L100,100 L0,100 Z;
                  M0,85 C15,80 30,90 50,85 C70,80 85,90 100,85 L100,100 L0,100 Z
                "
              />
              <animateTransform
            ...
            >
              <animate
                ...
                repeatCount="indefinite"
                values="
                  M0,88 C12,82 25,92 50,88 C75,84 88,92 100,88 L100,100 L0,100 Z;
                  M0,82 C18,88 38,78 50,82 C62,86 82,78 100,82 L100,100 L0,100 Z;
                  M0,88 C12,82 25,92 50,88 C75,84 88,92 100,88 L100,100 L0,100 Z
                "
              />
              <animateTransform
          ...
          {/* White TS logo centered */}
          <g
            clipPath={`url(#circle-${uid})`}
            transform="translate(17, 22) scale(0.082)"
          >
