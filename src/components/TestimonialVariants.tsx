...
const KanbanScatter = ({ testimonials }: Props) => {
  ...
  return (
    <div
      ...
      className="relative w-full h-[280px] md:h-[260px] rounded-3xl border border-border/60 shadow-[0_10px_30px_-12px_rgba(0,0,0,0.18)] bg-[radial-gradient(circle_at_1px_1px,hsl(var(--muted-foreground)/0.18)_1px,transparent_0)] [background-size:20px_20px] bg-muted/20 overflow-hidden touch-none"
    >
