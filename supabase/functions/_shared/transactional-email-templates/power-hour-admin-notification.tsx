...
const PowerHourAdminNotification = ({
  name,
  email,
  roleOrg,
  focus,
    ...
    <Html lang="en" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={leadText}>
            {amountStr} paid{couponCode ? ` · voucher ${couponCode}` : ''}
          ...
          <Row label="Voucher" value={couponCode} />
...
export const template = {
  ...
  previewData: {
    ...
    roleOrg: 'Head of Ops, Acme Charity',
    focus: 'Volunteer onboarding — manual emails, spreadsheets, slow handoff to coordinators.',
    amountPaid: 29500,
    couponCode: 'CHARITYMEETUP100',
    source: 'charity-meetup-april26',
    utmSource: 'charity-meetup',
    utmMedium: 'event',
    utmCampaign: 'april26',
    environment: 'live',
